...
{
    adios2::IO io = adios.DeclareIO("hello-world_writer");
    adios2::Variable<std::string> varGreeting = io.DefineVariable<std::string>("Greeting");

    adios2::Engine writer = io.Open("hello-world.bp", adios2::Mode::Write);
...
{
    adios2::IO io = adios.DeclareIO("hello-world_reader");
