...
void writer(adios2_adios *adios, const char *greeting)
{
    ...
    adios2_engine *engine = adios2_open(io, "example-mpi-c.bp", adios2_mode_write);
...
void reader(adios2_adios *adios, char *greeting)
{
    ...
    adios2_engine *engine = adios2_open(io, "example-mpi-c.bp", adios2_mode_read);
...
int main(int argc, char *argv[])
{
    MPI_Init(&argc, &argv);
    {
        ...
        const char greeting[] = "Hello World from ADIOS2 C/MPI example";
