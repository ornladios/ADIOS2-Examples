program adios2_global_array_fixed_write
    use mpivars
    use adios2
    implicit none
...
subroutine writer
    ...
    call adios2_open(engine, io, "adios2-global-array-fixed-f.bp", adios2_mode_write, ierr)
...
100 format (a,i2,a,i4,a,i1,a,i4)
    ...
    if (rank == 0) then
        ...
        write (*,'(a,a,i4)') &
            "  bpls -la adios2-global-array-fixed-f.bp ", &
            "GlobalArray -d -n ", fixed_shape(1)
        write (*,'(a,a,i4)') &
            "  bpls -la adios2-global-array-fixed-f.bp ", &
            "GlobalArray -d -t -n ", fixed_shape(1)
        write (*,'(a)') &
            "  mpirun -n 2 ./adios2-global-array-fixed-read-f "
    endif
end subroutine writer


end program adios2_global_array_fixed_write
